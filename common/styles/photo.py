...
PHOTO_STYLES = {
    ...
    # every one of these used to describe the *design* and never the picture. The
    # anchor here is the trade's own working method — a tilt-shift on a tripod,
    # verticals corrected in camera, available window light.
    ...
    "🏠 ИНТЕРЬЕР/🌿 Eco-Style Design": (
        "interior photograph of a biophilic space, 24mm tilt-shift lens at f/8, natural wood textures, green plant walls, diffused daylight through sheer curtains, organic materials, soft neutral palette, environmental integration, clean modern layout, architectural-magazine capture."
    ),
    "🏠 ИНТЕРЬЕР/👑 Baroque Ornate": (
        "interior photograph of a baroque palace hall, 24mm tilt-shift lens at f/11, long exposure on a tripod, gold leaf detailing, burgundy velvet fabric, crystal chandelier lighting, ornate carvings, high contrast highlights, reflective luxury surfaces, classical symmetry, heritage documentation photography."
    ),
    "🏠 ИНТЕРЬЕР/⬜ Minimalism": (
        "interior photograph of a minimalist room, 35mm lens at f/8, clean lines, negative space, neutral tones, soft diffused daylight, smooth surfaces, low visual noise, Japanese-inspired simplicity, balanced composition, available-light architectural capture."
    ),
    "🏠 ИНТЕРЬЕР/🏡 Country House": (
        "interior photograph of an English country house, 35mm lens at f/4, warm wood furniture, soft lamp lighting pools, floral textiles, cozy fabric layering, natural window light, lived-in domestic textures, calm rustic atmosphere, available-light home capture."
    ),
    # 👗 ФЭШН
    ...
    "🏙️ СРЕДА/☔ Rain Monsoon Puddle": (
        "photograph in monsoon rain, 35mm lens at 1/250s freezing the drops, puddle reflections, ripple water patterns, wet ground texture, splash droplets, flat overcast lighting, water beading on the front element, reflective surfaces, storm-documentary capture."
    ),
    "🏙️ СРЕДА/🇬🇧 London Smog": (
        "period photograph in Victorian fog, large-format plate camera on a tripod, long exposure, gaslight glow halos, dense smog atmosphere, muted brick textures, low visibility, damp air diffusion, historical urban documentation."
    ),
    # 🏜️ ЖАНРЫ
    ...
    # one the model has mostly seen as CG. Every entry here therefore names the
    # camera *and* says the hardware is practical — built props, prosthetic
    # makeup, on a real set under real lights.
    "🦾 КИБЕРПАНК/📱 Sleek White Android": (
        "photograph of a practical animatronic android on a robotics-facility set, 50mm lens at f/2.8, smooth white polymer shell with glowing cyan seam lines, synthetic skin appliance at the face, other identical units softly out of focus behind, cool facility lighting with soft blue accent glow, high-gloss surface reflections picking up the softboxes, product-launch photography of a built prop."
    ),
    ...
    "🦾 КИБЕРПАНК/🧬 Biomechanical Giger": (
        "photograph of a Giger-style practical creature suit, 50mm lens at f/4, dark glossy ribbed exoskeleton plating fused into bone-like struts, no visible organic skin left uncovered, cold blue-black palette, hard shadows carving the ribbed surface, latex and resin material sheen under the key light, on-set special-effects capture."
    ),
    ...
    "🧪 ЭФФЕКТЫ/📡 Тесла-катушка": (
        "long-exposure photograph of a tesla coil discharge, 4 seconds at f/8 on a tripod, high-voltage electric arcs, purple plasma glow, ionized air, branching lightning patterns, bright core highlights blowing out, dark background contrast, real electrical discharge captured in camera."
    ),
    "🧪 ЭФФЕКТЫ/🪞 Зеркальный мир": (
        "photograph built on mirror reflections, 35mm lens at f/5.6, symmetrical composition, reflective surfaces, duplicated geometry, infinite reflection effect, clean reflection edges, dust and fingerprints visible on the glass, in-camera optical symmetry."
    ),
    "🧪 ЭФФЕКТЫ/📺 CRT Scanlines": (
        "photograph of a CRT monitor, 1/30s shutter catching the refresh roll bar, visible scanlines, interlaced image, screen door effect, phosphor glow blooming into the lens, low resolution texture, moire between the shadow mask and the sensor, real screen captured off the tube."
    ),
    ...
    "🧪 ЭФФЕКТЫ/🧊 Absolute Zero": (
        "macro photograph in extreme cold, 100mm macro lens at f/11, focus-stacked, ice crystal formation, frozen droplets, frost textures, blue cold tones, sharp crystalline detail, condensation on the front element, scientific close-up capture."
    ),
    ...
    "🗺️ СЦЕНЫ/🎢 Amusement Park": (
        "amusement park night environment, densely packed crowd silhouettes against illuminated ride structures, multicolored string-light and neon-tube reflections, steel roller-coaster track geometry against dark sky, motion blur of spinning rides in the background, cotton-candy and popcorn stall lighting in the foreground, warm-tungsten and cool-LED mixed color temperature, 35mm lens at f/2 handheld, high ISO grain, festive night photograph."
    ),
    "🗺️ СЦЕНЫ/🌊 Ocean Wave": (
