...
PHOTO_STYLES = {
    ...
    "🎬 КИНО/📷 Anamorphic Wide": (
        "Panavision anamorphic lens, 2.39:1 cinematic aspect ratio, oval bokeh highlights, horizontal blue lens flares, compressed perspective, shallow depth of field, cinematic focus falloff, wide frame composition, film-grade optical rendering."
    ),
    ...
    "⏱️ ЗАХВАТ/🎞️ Slo-Mo Bullet Time": (
        "ultra high-speed Phantom Flex capture, extreme slow motion effect, suspended motion state, frozen debris and particles, crisp subject isolation, multi-angle capture feel, hyper-detailed temporal resolution, cinematic time dilation realism."
    ),
    # 🕰️ РЕТРО
    ...
    "🏠 ИНТЕРЬЕР/🏭 Loft Industrial": (
        "industrial loft interior, exposed brick walls, raw concrete floors, steel beam structure, large factory windows, hard directional daylight, dusty air particles, urban grit texture, high contrast interior realism, warehouse living aesthetic."
    ),
    "🏠 ИНТЕРЬЕР/🌻 Provence Rustic": (
        "French Provence interior, sun-bleached wood surfaces, terracotta floor texture, soft warm daylight, lavender tones, aged plaster walls, Mediterranean patina, natural material wear, rustic countryside realism."
    ),
    "🏠 ИНТЕРЬЕР/🕉️ Boho Chic": (
        "bohemian interior design, layered textiles, macrame decor, Moroccan rugs, rattan furniture, warm ambient lighting, mixed cultural elements, organic clutter composition, soft shadow diffusion, eclectic interior realism."
    ),
    "🏠 ИНТЕРЬЕР/🌿 Eco-Style Design": (
        "biophilic interior design, natural wood textures, green plant walls, diffused daylight, organic materials, soft neutral palette, environmental integration, clean modern layout, sustainable architecture realism."
    ),
    "🏠 ИНТЕРЬЕР/👑 Baroque Ornate": (
        "baroque palace interior, gold leaf detailing, burgundy velvet fabric, crystal chandelier lighting, ornate carvings, high contrast highlights, reflective luxury surfaces, classical symmetry, royal interior realism."
    ),
    "🏠 ИНТЕРЬЕР/⬜ Minimalism": (
        "minimalist interior design, clean lines, negative space, neutral tones, soft diffused lighting, smooth surfaces, low visual noise, Japanese-inspired simplicity, balanced composition, modern minimal realism."
    ),
    "🏠 ИНТЕРЬЕР/🏡 Country House": (
        "English country house interior, warm wood furniture, soft lamp lighting pools, floral textiles, cozy fabric layering, natural window light, lived-in domestic textures, calm rustic atmosphere, classic home realism."
    ),
    # 👗 ФЭШН
    ...
    "👗 ФЭШН/🖤 Chanel Aesthetic": (
        "black and white luxury fashion, high contrast grayscale, tailored fabric structure, matte skin finish, sharp textile detail, minimal lighting setup, Paris atelier style, refined composition, couture editorial realism."
    ),
    "👗 ФЭШН/💋 Pin-up Style": (
        "1940s pin-up photography, high contrast flash lighting, smooth skin highlights, stylized pose tension, glossy lipstick finish, soft backdrop gradients, vintage beauty lighting, playful retro composition, classic pin-up realism."
    ),
    "👗 ФЭШН/👔 Business Pro": (
    ...
    "🏙️ СРЕДА/🌃 Cyberpunk Neon": (
        "dry night urban street, dense layered neon magenta and cyan signage stacked overhead, reflective glass and metal storefronts, high contrast artificial lighting, thin vapor haze from food-stall steam, no rain or standing water, crowded market-alley energy, dark city atmosphere, cyberpunk realism."
    ),
    ...
    "🏙️ СРЕДА/🌫️ Foggy Neon Noir": (
        "dense fog environment, diffused neon lighting, soft light cones, reduced visibility, atmospheric depth layering, blurred background structures, damp surfaces, low contrast glow, moody urban realism."
    ),
    "🏙️ СРЕДА/🏚️ Dystopian Megacity": (
        "massive brutalist architecture, dense urban stacking, concrete textures, industrial decay, polluted atmosphere, harsh shadow contrast, vertical city scale, oppressive environment, dystopian realism."
    ),
    "🏙️ СРЕДА/🧱 Urban Grunge": (
        "street-level urban environment, worn concrete surfaces, chipped paint textures, graffiti layers, natural harsh lighting, high detail textures, gritty city realism, lived-in urban decay."
    ),
    ...
    "🏙️ СРЕДА/🌅 Magic Hour": (
        "golden hour lighting, low sun angle, warm highlights, long shadows, soft atmospheric haze, warm-cool color contrast, natural light gradient, cinematic outdoor realism."
    ),
    "🏙️ СРЕДА/☔ Rain Monsoon Puddle": (
        "monsoon rain scene, puddle reflections, ripple water patterns, wet ground texture, splash droplets, overcast lighting, reflective surfaces, storm atmosphere realism."
    ),
    "🏙️ СРЕДА/🇬🇧 London Smog": (
        "Victorian fog environment, gaslight glow halos, dense smog atmosphere, muted brick textures, low visibility, damp air diffusion, historical urban lighting realism."
    ),
    # 🏜️ ЖАНРЫ
    ...
    "📸 РЕПОРТАЖ/☕ Lifestyle Moment": (
        "lifestyle photography, natural available light, candid moment capture, soft shadow transitions, real human interaction, balanced exposure, magazine-quality realism, everyday scene authenticity."
    ),
    ...
    "🧪 ЭФФЕКТЫ/🤖 Holographic HUD": (
        "transparent holographic interface overlay, cyan-magenta UI glow, floating digital elements, screen-space projection, light emission edges, reflective glass interaction, sci-fi display optics, augmented reality visual layer."
    ),
    "🧪 ЭФФЕКТЫ/💡 Hard Rim Neon": (
        "strong rim lighting, backlit RGB edge glow, high contrast silhouette, dark background separation, light wrap on edges, haze light scattering, nightclub lighting aesthetic, neon edge definition."
    ),
    ...
    "🧪 ЭФФЕКТЫ/🌫️ Volumetric Tyndall Dust": (
        "volumetric light rays, visible dust particles, Tyndall effect, god rays through atmosphere, soft light scattering, depth haze, illuminated air particles, cinematic light beams."
    ),
    ...
    "🧪 ЭФФЕКТЫ/🌈 HDR Dynamic": (
        "HDR photography, extended dynamic range, tone mapping, highlight recovery, shadow lifting, hyper-detailed exposure, high contrast realism, digital HDR rendering."
    ),
    "🧪 ЭФФЕКТЫ/🕯️ Candlelit Mood": (
        "candlelight illumination, warm low color temperature, flickering light source, deep shadow falloff, localized highlights, soft glow on surfaces, low-light atmosphere, warm cinematic lighting."
    ),
    ...
    "🦾 КИБЕРПАНК/📱 Sleek White Android": (
        "futuristic consumer android in a sleek robotics facility, smooth white polymer shell with glowing cyan seam lines, synthetic skin integration at the face, other identical white android units visible softly out of focus in the background, cool facility lighting with soft blue accent glow, high-gloss surface reflections, premium consumer-tech realism."
    ),
    "🦾 КИБЕРПАНК/🪞 Chrome Android": (
        "liquid-mirror chrome android face, fully reflective polished metal skull retaining exact human facial structure and expression, surrounding environment visible warped in the reflection, cold blue rim lighting against a near-black background, razor-sharp specular highlights along cheekbone and brow, dripping wet-metal sheen, cinematic T-800-style cybernetic realism."
    ),
    "🦾 КИБЕРПАНК/💉 Wirehead Junkie": (
        "street-level cyberpunk augmentation, exposed wires, neural implant scars, damaged cyberware, rusted metal parts, glowing faulty implants, gritty lighting, urban decay textures, low-life cybernetic realism."
    ),
    "🦾 КИБЕРПАНК/🏢 Corpo-Cyborg": (
        "corporate cyberpunk augmentations, clean surgical implants, gold and carbon fiber materials, precise panel seams, polished surfaces, controlled lighting, high-end tech aesthetic, elite cybernetic realism."
    ),
    "🦾 КИБЕРПАНК/🎖️ Military Cyborg": (
        "military cybernetic body, armored prosthetics, reinforced joints, tactical plating, weapon-grade materials, combat-ready design, harsh directional lighting, battlefield realism, functional cybernetic integration."
    ),
    "🦾 КИБЕРПАНК/⚔️ Cyber-Samurai": (
        "cyberpunk samurai armor studio portrait, segmented metal plating catching a single hard rim light, katana-ready augmentations, static disciplined stance against a dark seamless backdrop, no environment or weather, controlled high contrast studio lighting, futuristic warrior aesthetic."
    ),
    "🦾 КИБЕРПАНК/🧬 Biomechanical Giger": (
        "H.R. Giger-style biomechanical fusion, dark glossy ribbed exoskeleton plating fused directly into bone-like alien struts, no visible organic skin left uncovered, cold blue-black palette, high contrast shadows carving the ribbed surface, xenomorph-adjacent alien-machine realism, industrial horror aesthetic."
    ),
    "🦾 КИБЕРПАНК/🧪 Biopunk Organic": (
        "biopunk augmentation, thick pulsing subdermal circuitry visible through translucent living tissue, wet glistening organic membrane stretched over glowing bio-implants, greenish bio-luminescent veins, warm humid lab-terrarium lighting, genetic modification realism."
    ),
    "🦾 КИБЕРПАНК/🌱 Solarpunk Hybrid": (
        "solarpunk cybernetics, organic materials with embedded tech, soft bioluminescent elements, clean natural lighting, eco-tech integration, smooth surfaces, futuristic sustainable design realism."
    ),
    "🦾 КИБЕРПАНК/💀 Post-Apoc Cyber": (
        "post-apocalyptic cyberware, scavenged prosthetics, exposed bolts and joints, damaged surfaces, rust and dirt textures, asymmetrical body modifications, harsh lighting, survival cyberpunk realism."
    ),
    ...
    "🦾 КИБЕРПАНК/🤍 White Android Minimal Studio": (
        "single android bust isolated on a seamless white cyclorama, matte ceramic-white shell with no visible background elements, fine hairline panel seams only, flat shadowless high-key softbox lighting from all sides, zero ambient color cast, product-launch keynote sharpness, nothing else in frame, elegant synthetic-face realism."
    ),
    ...
    "🦾 КИБЕРПАНК/🧩 Android Anatomy Cutaway": (
        "android anatomy cutaway photo-real render look, partially exposed robotic internals, layered engineering detail, synthetic cross-section surfaces, clean medical lighting, precise mechanical anatomy, high-detail lab documentation realism."
    ),
    ...
    "🦾 КИБЕРПАНК/🪞 Molten Liquid Chrome Realism": (
        "the subject's skin and hair rendered as molten liquid chrome, mercurial mirror-metal surface flowing and dripping slightly at the jawline and hairline, stretched specular highlight bands wrapping the face, viscous metal sheen catching studio light, high-contrast reflections of the surrounding room bending across the cheek, wet polished material response, futuristic luxury cyber-material portrait."
    ),
    ...
    "🧪 ЭФФЕКТЫ/📡 Тесла-катушка": (
        "tesla coil discharge, high-voltage electric arcs, purple plasma glow, ionized air, branching lightning patterns, bright core highlights, dark background contrast, electrical energy realism."
    ),
    "🧪 ЭФФЕКТЫ/🪞 Зеркальный мир": (
        "mirror reflections, symmetrical composition, reflective surfaces, duplicated geometry, infinite reflection effect, clean reflection edges, glass and mirror interaction, optical symmetry realism."
    ),
    "🧪 ЭФФЕКТЫ/📺 CRT Scanlines": (
        "CRT monitor display, visible scanlines, interlaced image, screen door effect, phosphor glow, low resolution texture, analog display distortion, retro screen realism."
    ),
    "🧪 ЭФФЕКТЫ/🔦 Полицейский прожектор": (
        "single hard spotlight, high intensity beam, sharp shadow edges, strong falloff, dark surrounding space, dramatic interrogation lighting, high contrast illumination realism."
    ),
    "🧪 ЭФФЕКТЫ/🌊 Цифровой муар": (
        "moire pattern artifact, interference lines, high-frequency texture distortion, repeating wave patterns, digital aliasing effect, fabric or screen interference realism."
    ),
    "🧪 ЭФФЕКТЫ/🫧 Мыльные пузыри": (
        "soap bubble surface, thin-film interference, rainbow reflections, iridescent colors, smooth spherical surface, light refraction, soft highlights, optical physics realism."
    ),
    "🧪 ЭФФЕКТЫ/🕶️ Солнечное затмение": (
        "solar eclipse, darkened sun disk, corona light halo, partial shadow coverage, high contrast sky, astronomical lighting, natural celestial realism."
    ),
    ...
    "🧪 ЭФФЕКТЫ/🟣 UV Fluorescence": (
        "UV light fluorescence, 365nm ultraviolet excitation, glowing reactive surfaces, high contrast dark background, neon color emission, selective material glow, ultraviolet lighting realism."
    ),
    "🧪 ЭФФЕКТЫ/💥 High-Speed Shatter": (
        "high-speed shatter capture, glass fragmentation, flying debris, sharp shard edges, frozen explosion moment, particle detail, impact physics realism."
    ),
    ...
    "🧪 ЭФФЕКТЫ/🌑 Silhouette Drama": (
        "strong backlighting, dark subject silhouette, bright background source, sharp outline contrast, minimal detail in shadows, high contrast graphic realism."
    ),
    "🧪 ЭФФЕКТЫ/🧊 Absolute Zero": (
        "extreme cold environment, ice crystal formation, frozen droplets, frost textures, blue cold tones, sharp crystalline detail, cryogenic realism."
    ),
    "🧪 ЭФФЕКТЫ/⚒️ Forgemaster Heat": (
        "forge environment, glowing hot metal, sparks and embers, heat haze distortion, orange light emission, industrial workshop realism."
    ),
    ...
    "🧪 ЭФФЕКТЫ/🌊 Bioluminescence": (
        "bioluminescent glow, blue-green light emission, organic light sources, dark environment contrast, underwater glow effect, natural biological illumination realism."
    ),
    "🧪 ЭФФЕКТЫ/🎭 Hard Chiaroscuro": (
        "hard directional light, extreme light-shadow contrast, sharp shadow edges, deep black negative space, sculpted subject form, dramatic lighting realism."
    ),
    ...
    "🗺️ СЦЕНЫ/🎪 Circus Big Top": (
        "circus tent interior, spotlight beams, sawdust floor texture, striped fabric canopy, warm theatrical lighting, high contrast shadows, performance stage atmosphere, vintage circus realism."
    ),
    "🗺️ СЦЕНЫ/🛁 Bathroom Mirror": (
        "bathroom mirror reflection, steam condensation on glass, soft indoor lighting, skin moisture highlights, tiled surfaces, intimate daily environment realism."
    ),
    "🗺️ СЦЕНЫ/🔮 Crystal Ball": (
        "crystal ball reflection, dark room environment, point light highlights, glass refraction, glowing sphere effect, mystical lighting contrast, optical realism."
    ),
    "🗺️ СЦЕНЫ/🖼️ Art Gallery": (
        "modern art gallery interior, white cube walls, track lighting, clean shadows, polished floor reflections, minimal composition, exhibition space realism."
    ),
