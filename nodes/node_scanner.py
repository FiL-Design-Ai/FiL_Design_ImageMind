    ...
    def define_schema(cls):
        return io.Schema(
            ...
            inputs=[
                ...
                io.String.Input("prompt", default="", multiline=True, tooltip=t("tt_prompt", "User instruction or standalone text prompt. If image is connected, this becomes the instruction; without image, it is the full text input.")),
                io.String.Input("negative_prompt", default="", multiline=True, tooltip=t("tt_neg_prompt", "What to avoid in the generated prompt."), advanced=True),
