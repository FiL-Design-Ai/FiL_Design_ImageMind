 ...
 * preview thumbnail URL under ComfyUI's /extensions/FiL_Design_ImageMind/ static root.
 *
 * NOTE: `_gen_style_previews.py` is not present in this repo (last known
 * generator script is missing). Base path was hand-synced via bulk find/replace
 * during the FiL_LLM -> FiL_Design_ImageMind rename (2026-07-10) — only the
 * base path token changed, hashes are untouched. Restore the generator before
 * regenerating this file any other way.
 */
